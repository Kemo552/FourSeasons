<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Contacts.aspx.cs" Inherits="WebApplication2.Admin.Contacts" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkDelete" runat="server" Text="Delete" CssClass="badge bg-danger"
                                                                        CommandArgument='<%# Eval("ContactId") %>' CommandName="delete" OnClientClick="return confirm('Do you want to delete this record?');">
                                                                       <i class="ti-trash"></i>
                                                                    </asp:LinkButton>
                                                                </td>
                                                            </tr>
