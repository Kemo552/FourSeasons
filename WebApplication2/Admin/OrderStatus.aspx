<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="WebApplication2.Admin.OrderStatus" %>
                                            ...
                                            <asp:Panel ID="pUpdateOrderStatus" runat="server">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="pb-5">
                                                        ...
                                                        &nbsp;
                                                    <asp:Button ID="btnClear" runat="server" Text="Cancel" CssClass="btn btn-primary" OnClick="btnClear_Click" />
                                                    </div>
                                                </div>
                                            </asp:Panel>
                                        </div>
