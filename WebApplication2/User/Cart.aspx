<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="WebApplication2.User.Cart" %>
            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <%-- Image --%>
                            <img width="60" src='<%# Connection.Utils.GetImageUrl(Eval("imageUrl")) %>' />
                        </td>
                        <td>
                            <%-- Unit Price --%>
                ...
                <FooterTemplate>
                    ...
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="Menu.aspx" class="btn btn-outline-dark"><i class="fa fa-arrow-circle-left mr-2"></i>Continue Shopping</a>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:LinkButton ID="lbCheckout" runat="server" CommandName="checkout" CssClass="btn btn-outline-success">
                                        To Payment<i class="fa fa-arrow-circle-right ml-2"></i>   
                            </asp:LinkButton>
                        </td>
                    </tr>
                    </tbody>
