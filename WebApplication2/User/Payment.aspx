<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="WebApplication2.User.Payment" %>
                ...
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                        <div class="card-header">
                            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                ...
                                <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                    ...
                                    <li class="nav-item"><a data-toggle="pill" href="#paypal" class="nav-link "><i class="fa fa-money-bill mr-2"></i>Cash On Delivery </a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <div role="form">
                                        ...
                                        <div class="">
                                            <asp:LinkButton ID="lbCardSubmit" runat="server" CssClass="subscribe btn btn-outline-success btn-block shadow-sm"
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    ...
                                    <p class="user_option">
                                        <asp:LinkButton ID="lbCodSubmit" runat="server" CssClass="btn btn-outline-success" ValidationGroup="cod" OnClick="lbCodSubmit_Click">
                        ...
                        <div class="card-footer">
                            <b class="badge badge-dark badge-pill shadow-sm">Order Total: $ <% Response.Write(Session["grandTotalPrice"]); %> </b>
                            <div class="pt-1">
