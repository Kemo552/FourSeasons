<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="WebApplication2.User.Profile" %>
                            ...
                            <div class="card-title mb-4">
                                <div class="d-flex justify-content-start">
                                    <div class="image-container">
                                        <img src='<%= Connection.Utils.GetImageUrl(imageUrl)%>' id="imageProfile" style="width:150px; height:150px;" class="img-thumbnail"/>
                                        <div class="middle pt-2">
                                            <a href="Registeration.aspx?id=<% Response.Write(Session["userId"]); %>"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a href="#basicInfo" class="nav-link active text-info" id="basicInfo-tab" data-toggle="tab" role="tab"
                                                aria-controls="basicInfo" aria-selected="true">
                                                <i class="fa fa-id-badge mr-2"></i> Basic Info
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#connectedServices" class="nav-link text-info" id="connectedServices-tab" data-toggle="tab" role="tab"
                                                    ...
                                                    <div class="container">
                                                        <div class="row pt-1 pb-1" style="background-color: lightgray;">
                                                            <div class="col-4">
                                                                ...
                                                                Payment Mode: <%# Eval("PaymentMode").ToString() == "cod" ? "Cash On Delievery" : Eval("PaymentMode").ToString().ToUpper() %>
                                                            </div>
                                                            <div class="col-6">
